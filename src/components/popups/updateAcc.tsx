    ...
    return (
        <div className='fixed top-0 left-0 h-screen w-screen bg-[#00000066] z-10'>
            <div className='h-[80vh] w-[90vw] bg-white rounded-xl mt-[10vh] ml-[5vw] flex justify-between items-center px-16'>
                <button 
                    onClick={onClose}
                    className='h-8 w-8 bg-[#FB4A4A] absolute top-[11.5vh] right-[6vw] rounded-full flex items-center justify-center'
                >
                ...
                <div className='relative h-[60%] w-[30%] flex flex-col items-center justify-center mb-[5vh]'>
                ...
                <div className='h-[60%] w-[60%] mt-[9vh]'>
                    <h1 className='text-black font-medium text-5xl'>Edit Details</h1>
                    <div className=' h-fit flex flex-col items-center mt-6'>
                        <input type="email" placeholder='Enter Email' className='h-[6vh] w-full mt-10 text-lg bg-slate-100 border border-gray-200 rounded-lg pl-4' />
                        <div className="mt-10">
                            <input type="password" placeholder="Enter Password" className="h-[6vh] w-[50vw] text-lg bg-slate-100 border border-gray-200 rounded-lg pl-4" />
                        </div>
                        <div className='flex'>
                            <button
                                className='h-[6vh] w-[23vw] mt-10 font-semibold text-xl text-white bg-[#FB4A4A] rounded-lg flex items-center justify-center'>
                            ...
                            <button
                                className='h-[6vh] w-[23vw] mt-10 ml-[3.5vw] font-semibold text-xl text-white bg-[#002F53] rounded-lg flex items-center justify-center'>
                                <svg className='h-[2.5vh] w-[2vw]' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                    <path fill="white" d="M231.4 44.34v.15l-58.2 191.94a15.88 15.88 0 0 1-14 11.51q-.69.06-1.38.06a15.86 15.86 0 0 1-14.42-9.15l-36.4-74.7a4 4 0 0 1 .77-4.58l57.92-57.92a8 8 0 0 0-11.31-11.31l-57.95 57.92a4 4 0 0 1-4.58.77l-74.77-36.39a16 16 0 0 1 2.49-29.8l191.94-58.2h.15a16 16 0 0 1 19.74 19.7" />
                                </svg>
                                Connect Account
