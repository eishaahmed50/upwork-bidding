...
const SignupForm = () => {
    ...
    return (
        <div>
            <h1 className='text-[3vw] font-bold mt-[12vh] ml-[8vw]'>Create Account</h1>
            <div className='h-fit mt-[5vh] mx-[8vw] flex flex-col place-items-center'>
                <input
                    type="text"
                    placeholder='Enter Full Name'
                    className='h-[6vh] w-[40vw] mt-10 mr-[12vw] bg-slate-100 border border-gray-200 rounded-lg pl-4'
                />
                <input
                    type="email"
                ...
                <button className='h-[6vh] w-[40vw] mt-10 mr-[12vw] font-semibold text-white bg-[#002F53] rounded-lg flex items-center justify-center'>
                    <svg className='text-xl mr-2' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                ...
                <div>
                    <p className='mt-3 mr-[37vw] font-semibold text-slate-500'>
                        Already have an account? <a href="/login" className='text-[#002F53] hover:underline'>Log in</a>
                    </p>
                </div>
            </div>
        </div>
